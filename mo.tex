...
\begin{center}
\begin{tikzcd}
E \sm T(\xi) \arrow{d}{\eta_{MO} \sm 1 \sm 1=f} \arrow[densely dotted]{r}{\theta_E} & E \sm \Susp^\infty_+ X \arrow{d}{\eta_{MO} \sm 1 \sm 1} \\
MO \sm E \sm T(\xi) \arrow{r}{\theta_{MO} \sm E} \arrow{d}{(\mu \circ (\phi \sm 1)) \sm 1=g} & MO \sm E \sm \Susp^\infty_+ X\arrow{d}{(\mu \circ (\phi \sm 1)) \sm 1=h} \\
