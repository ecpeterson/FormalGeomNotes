...
We will close out this section by using this to actually make a calculation. Recall from \Cref{RPnThomExample} that $T(\L \downarrow \RP^n) = \RP^{n+1}$.  Because $MO$ is a connective spectrum, the truncation map \[MO \to MO(-\infty, 0] = H\pi_0 MO = H\F_2\] is a map of ring spectra\citeme{Find a reference for this, which I actually am not sure how to prove. Allen said Corollary 6.6 of https://arxiv.org/pdf/0806.3983v1.pdf is relevant}.  Hence, we can apply the Thom isomorphism theorem to the mod--$2$ homology of Thom complexes coming from real vector bundles:
\begin{align*}
