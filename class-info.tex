...
This document was compiled on \today. This may not reflect when it was cloned from git, though.\todo{I would like this to print the git HEAD's id, if it exists.}
