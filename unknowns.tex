...
At the top of page 10 Neil talks in FPFP very briefly about Greenlees--May and local homology.
...
DISCUSSION OF ``SPECTRAL FORMAL GROUPS'' AND LOCAL CFT
...
The superior algebraic geometry of the derived moduli of elliptic curvs.
...
Hopkins's program for $p$--adic interpolation and Salchian $L$--functions.  Description of the Lubin--Tate tower and the local Langlands correspondence
