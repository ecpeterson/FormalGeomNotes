...
\todo{Danny was asking some interesting questions about the relationships between the $t_i$ and the $h_j$ elements of the Adams spectral sequence.  You could try to explain some of this comparison and how you get the Hopf invariant one theorem out of it.  This could also include a brief discussion of the (geometric and algebraic) chromatic spectral sequence(s).}
