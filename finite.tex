...
\begin{remark}
\todo[inline]{Maybe we can say something about $H\Z \sm MU$ here, since that's the ring used in the proof of Lazard's theorem.  Also, Section 12 of Neil's FG notes talk about the infinite height subscheme of $\moduli{fgl}$. He compares it to $H_* MO$ and to the Hurewicz image $\pi_* MU \to H_*(MU; \F_p)$.}
\end{remark}
