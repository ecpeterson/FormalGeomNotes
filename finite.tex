...
\begin{theorem}[{cf.\ \Cref{RationalFGLsHaveLogarithms}}]
...
\begin{theorem}[{\cite[Corollary 2.4 and Proposition 2.5]{Landweber}, cf.\ \cite[Theorem 4.9]{Wilson}}]\label{LandwebersClassificationOfClosedSubstacks}
...
\todo{Talk about flatness and formal completions.  The point is that $\moduli{fg}$ is not Noetherian, but each geometric point except $\G_a$ lives in an open substack that happens to be Noetherian.}
...
\todo{This used to be a section break}
