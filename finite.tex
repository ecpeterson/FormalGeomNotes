...
\todo[inline]{I don't think I mention Hopf algebroids during this lecture! This is a miserable oversight that \emph{must} be corrected.}
...
\end{corollary}
\begin{proof}
Consider the diagram\todo{You haven't justified why the arcing arrow is named $u$.  This comes out of understanding the flip action, and it should also yield a proof of the Corollary below.}
\begin{center}
\begin{tikzcd}
...
\todo[inline]{Also, people seem to say things about the Mischenko logarithm rather than the invariant differential, but I think we should phrase things in those terms.  Also also, Section 12 of Neil's FG notes talk about the infinite height subscheme of $\moduli{fgl}$. He compares it to $H_* MO$ and to the Hurewicz image $\pi_* MU \to H_*(MU; \F_p)$.}
