...
\todo{These three lectures are now kind of imbalanced.  The $p$--typical discussion is really long, and Lazard's theorem is not that hard.  They should be rebalanced.}
...
\begin{remark}
\todo{Get rid of this remark entirely.  You don't talk about $n$--buds anymore.}
