...
\todo[inline]{I would like to put an example here for the composite map $\Z \to \Z^\wedge_p \to \Z/p$.  Without passing to the derived category, doing descent from $\Z$--modules to $\Z/p$--modules is obviously impossible, but I think that in the derived category descending an (honest) module from $\Z$ to descent data over $\Z/p$ is exactly enough information to reconstruct an (honest) module over $\Z^\wedge_p$.}
