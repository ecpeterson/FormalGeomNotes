...
\end{itemize}
This will occupy us for the next two lectures.\todo{``occupy'' is used twice}
...
Verifying that the claims are equivalent to one another is straightforward.  Claim (1) is the version that actually get proved, by considering the homological algebra of formal groups.  \todo{More on this tomorrow?}
\end{proof}
