...
\todo[inline]{The rest of this lecture is written with respect to logical order rather than with respect to narrative order. The narrative could use a lot of beefing up.}
...
\begin{theorem}\label{LazardsTheorem}\citeme{Lazard}
...
This finally concludes the proof of \Cref{LazardsTheorem}.  We now deduce an important topological consequence:
\begin{corollary}
...
\begin{center}
\begin{tikzcd}
U \arrow{r}{v} & L_\infty \arrow{r}{\delta} \arrow[bend left]{rrr}{u} & MU_* \arrow{r}{1 \sm \eta_{H\Z}} & MU_* H\Z \arrow[-,double]{r} & U.
\end{tikzcd}
\end{center}
In \Cref{QuillenSurjective}, we previously showed that $\delta$ was surjective.  To see that $\delta$ is also injective, notice that the first map is an isomorphism and the long composite is injective.
\end{proof}
