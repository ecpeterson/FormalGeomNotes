...
\begin{center}
\begin{tikzcd}
\Spec R \arrow{r}{f} & \moduli{fgl} \arrow[-,double]{r} \arrow{d} & \context{MUP}[0] \arrow{d} \arrow[-,double]{r} & \Spec MUP_0 \\
& \moduli{fg} \arrow[-,double]{r} \arrow[leftarrow]{lu} & \context{MUP},
\end{tikzcd}
...
Talk about Hopkins's stacky pullback theorem from his Talbot lecture?  I think we can only do this \emph{after} Quillen's theorem has been proven, though it only really fits conceptually into the lecture on contexts.
