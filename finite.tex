...
Although this didn't affect the previous Theorem statement, one is led by its proof to wonder there exist such spectra $X \in \CatOf C_d \setminus \CatOf C_{d-1}$---i.e., whether these subcategorical containments are proper.  The following result lays this to rest:
