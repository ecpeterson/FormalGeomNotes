...
\section{Special divisors and the special splitting principle}
...
\noindent This Lemma was missing a nontriviality statement, which turns out to be much harder:
...
\end{tikzcd}
\end{center}
This is called \textit{the adjoint map}, and it encodes equivalent information to the map of $E_*$--modules \[E_* \to E_* Y \widehat\otimes_{E_*} E^* X\] by considering where it sends $1 \in E_*$.  This construction converts many properties of $f$ into corresponding properties of this adjoint element --- for instance, it is natural in the source, and it converts sums to products.\todo{Expand on this, perhaps.}
\end{definition}
