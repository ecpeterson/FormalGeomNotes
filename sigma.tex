...
Starting today, after our extended interludes on chromatic homotopy theory and cooperations, we are going to return to thinking about bordism orientations directly.  Recall that in \Cref{ComplexBordismChapter} we deduced descriptions of the sets of ring maps $MU \to E$:
\begin{theorem}[{\Cref{ComplexOrientationsInTermsOfTrivs}}]
There is a bijection between ring maps $MU \to E$ (resp., $MUP \to E$) and trivializations of the line bundle $\ThomSheaf{\L - 1}$ (resp., $\ThomSheaf{\L}$) on the formal scheme $\CP^\infty_E$.  In fact, such trivializations are encoded by the scheme-theoretic data $(\Spec E_0 MU)(E_0)$ (resp., $(\Spec E_0 MUP)(E_0)$). \qed
\end{theorem}
