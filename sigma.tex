...
\section{Covariance and $\Theta$--structures on Thom sheaves}
...
\end{corollary}
\begin{proof}
\todo{Explicit calculation of the Verschiebung (cf.\ the ``wrinkle'' in the previous section) + Milnor--Moore}
\end{proof}
