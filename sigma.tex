...
We are left with showing that the factorized map is an isomorphism, and again appealing to Atiyah--Hirzebruch spectral sequences it suffices to show this in the case $E = H\F_2$.  The diagram considered above extends as follows:
\begin{center}
\begin{tikzcd}
\Spec H\F_2P_0 BSU \arrow["H\F_2P_0 i"]{r} \arrow[equal]{d} & \Spec H\F_2P_0 \Spin/SU \arrow["H\F_2P_0 j"]{r} \arrow[densely dotted]{d} & \Spec H\F_2P_0 BSU \arrow[equal]{d} \\
