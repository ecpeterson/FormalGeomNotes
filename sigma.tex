...
As a warm-up, we will use these ideas to study the available complex orientations of a given complex-orientable theory.

\todo[inline]{The $E$--homology of $MU$ is supposed to be $C^1(\CP^\infty_E; \sheaf I(0))$, with $E$--linear dual the $E$--cohomology of $MU$.  A map $MU \to E$ of rings is detected by a map $E_* MU \to E_*$ of $E_*$--algebras.}

\todo{The phrasing of $MUP$ and $MU$ orientations in terms of $C^0$ and $C^1$--structures.  (Maybe avoid using this notation, though, since the special divisor presentation is nontrivially equivalent to $C^2$?)}

\todo{Relationship between $X^E$ and $X_E$ for a nice $H$--space $X$.}
