...
Coalgebras over a field are ind-finite

Coalgebras with an ind-finiteness property are called ``good'', the formal schemes they model are called ``coalgebraic''

Diagrams of coalgebras with good colimits beget colimit diagrams of coalgebraic formal schemes

Use this to construct the various stable divisor schemes and verify the freeness assertions about them



Maybe build the ring $C_*(\G)$
