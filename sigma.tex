...
\begin{example}
Let us expand this in the case of $N = 2$.  The four functions involved are
\begin{center}
\begin{tabular}{|c||c|}
\hline
Function & Zero locus \\
\hline \hline
$\theta_q^{0,0}$ & $\Lambda + \frac{\tau + 1}{2}$ \\
$\theta_q^{0,1/2}$ & $\Lambda + \frac{\tau}{2}$ \\
$\theta_q^{1/2,0}$ & $\Lambda + \frac{1}{2}$ \\
$\theta_q^{1/2,1/2}$ & $\Lambda$. \\
\hline
\end{tabular}
\end{center}
