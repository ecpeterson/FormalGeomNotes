...
Secondly, with the homotopy category exposed, we turn to \(E_\infty\)--ring spectra themselves: in \Cref{ConstructionOfTMFSection} we introduce the spectrum \(\TMF\), which is the primary target of the \(\String\)--orientation; and in \Cref{JuvitopTalkSection}, we give a summary of the known results about \(E_\infty\) orientations---including, in particular, the full details of the construction of \(\Spin\)--orientation of \(KO\).
