...
& & \Susp^{-1} \Q/\Z \otimes \widehat L_1 \gl_1 \tmf \arrow{rr} & & |[alias=glKOp]| \widehat L_1 \gl_1 \tmf \arrow{ru}[description]{\ell_1} \arrow{rr} & & \Q \otimes \widehat L_1 \gl_1 \tmf \arrow[very thick]{ru}[description]{\ell_1} \arrow{rr} \arrow[densely dotted, leftarrow, crossing over, "C"' near end]{uu} & & \Q/\Z \otimes \widehat L_1 \gl_1 \tmf.
\end{tikzcd}
