...
\begin{corollary}
\citeme{This must be a consequence of Strickland's / Rezk's results}
...
\begin{theorem}[{\cite[Theorem 2.5.7]{Ando}, \cite{PetersonStapleton}}]\label{AndosAlgebraicTheorem}
