...
This accounts for both $\EinftyRings(M\Spin, \Q \otimes KO)$ and $\EinftyRings(M\Spin, \Q \otimes KO_p)$: the set of rational characteristic series includes into the set of ad\`elic characteristic series as the subset with rational coefficients.
...
We want to understand $\EinftyRings(M\Spin, KO_p)$ and its map to $\EinftyRings(M\Spin, \Q \otimes KO_p)$.  Here's the initial set-up:
\begin{center}
\begin{tikzcd}[
