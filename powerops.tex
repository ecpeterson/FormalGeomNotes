...
\section{The spectrum of modular forms}
...
\todo{The $\tmf$ sheaf exists: $\moduli{ell}$ has affine cover $\mathbb A^1$, $\overline{\moduli{ell}}$ has affine cover $\mathbb P^1 = \mathbb A^2 \setminus \{0\} / \Gm$, and that extends to a sheaf on $\mathbb A^2 / \Gm$.  \'Etale maps miss this extra bad point, so this is mostly just fussing with gluing data, and then only in the rational situation.}
