...
\begin{itemize}
    ...
    \item \Cref{SectionMfgSmallScales} now makes use of the Kodaira--Spencer map to justify the precise form of the deformation complex.  Unfortunately, this modified some of the theorem numbering in this section.
