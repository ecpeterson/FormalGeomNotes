...
% this needs to be re-done because \D is an important svmono command, hold on
...
\def\section#1{%
    ...
    \temptoks{#1}
    \edef\temp{
        \@nx\oldsection[\rlap{\lecturedate:}\hskip\tocspacerlength\the\temptoks]{\lecturedate: \the\temptoks}%
    }
    \temp
}
\makeatother
