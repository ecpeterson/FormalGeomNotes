...
% amsthm has better proof handling
...
% fixes svmono to be compatible with rotating / latex standards
...
\let\construction\relax\let\endconstruction\relax
...
\spnewtheorem{warning}[theorem]{Warning}{\bfseries}{\rmfamily}
% remarks
\spnewtheorem{remark}[theorem]{Remark}{\itshape}{\rmfamily}
\spnewtheorem{example}[theorem]{Example}{\itshape}{\rmfamily}
