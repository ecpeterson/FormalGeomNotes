...
\begin{theorem}
Hopefully we've set this up so that it's obvious that the $0$--line has the Hurewicz homomorphism in it.  Maybe this needs comparison to the constant tower at $\S$?
\end{theorem}

What remains to do is to identify the information in this spectral sequence with the story that we began the hour with.  In order to do this, we will have to investigate a little homological algebra.  We will do this next time.
...
Commutative Hopf algebras from groups: the algebra of functions
...
Comparison with Yoneda extensions
...
\todo{This is a bad name.  Maybe ``Unstable cooperations''?}
