...
% \newcommand{\MfgG}{(\mathcal{M}_{\text{fg}})^{\wedge}_{\Gamma}}
...
% \newcommand{\Bprime}{B_{t}^{'}}
% \newcommand{\Gti}{\tilde{G}_{\alpha}}
% \def \mmod{/\mkern-3mu /}

% \title{An Introduction to HKR Character Theory}
% \author{
% Nathaniel Stapleton \\   
% }
% \date{\today}
% \documentclass[10pt]{article}
% \usepackage{amssymb,amsfonts,amsthm,amsmath,verbatim, mathrsfs}
% %\usepackage{thmtools}
% \usepackage[all]{xy}
...
% \newtheorem{surprise}[subsection]{Surprise}
% \newtheorem*{solution}{Solution}
% \newtheorem{note}[subsection]{Note}
% \newtheorem*{remark}{Remark}

% %\renewenvironment{example}{Example}{$\blacktriangle$}
% %\declaretheorem[style=definition,qed=$\blacksquare$]{example}
% %\newenvironment{ex}{Example}{?}
% \begin{document}
% \maketitle
%useful commands: \xymatrix{} \cite{} \ref{} \label{}
%quick \xymatrix example
%\[
%\xymatrix{\Lambda_{k-1}^* \ar[r]^{\rho_{k}^*} \ar[d] & \Lk^* \ar[d] \\
%				\G[p^{k-1}] \ar[r]^{i_k} & \G[p^k]}
%\] 
...
It follows that $E^*(BA)$ is a free $E^*$-module of rank $p^{k_1d+\cdots + k_id}$. Add a comment about $A$ not a $p$-group.
...
\begin{theorem} (Equivariant CW Approximation)
...
Recall from \Cref{StrictCechDescentRemark} that a commutative ring extension $R \rightarrow S$ gives rise to a cosimplicial commutative ring
\[\left\{
