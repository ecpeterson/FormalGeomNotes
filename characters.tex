...
\begin{theorem}[{Equivariant CW Approximation, \cite[Chapter I.1]{MayAlaska}}] \label{app:CWapprox}
...
\]
This choice of $\Lambda$ is the only choice made in this Lecture. The last subsection of this Lecture addresses how natural the character map is in automorphisms of $\Lambda$.\footnote{From a certain perspective, the results of Barthel--Stapleton~\cite{BarthelStapleton} can be viewed as an analysis of how natural the character map is among finite index maps $\Lambda \hookrightarrow \Lambda$.}
...
\end{proposition}
\begin{proof}
This follows from Section 6 of ??.\citeme{citation}
\end{proof}
...
\[
\InternalHom{TopologicalGroupoids}(* \mmod \Lambda, (G/A) \mmod G) \simeq \InternalHom{TopologicalGroupoids}(* \mmod \Lambda, * \mmod A).
\]
