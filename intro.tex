...
& = \left. \left\{ \begin{array}{c}\text{oriented $n$--manifolds $Z$} \\ \text{with a specified class $\omega \in H^n(M; \Z)$} \end{array}\right\} \middle/ \sim \right. .
\end{align*}
