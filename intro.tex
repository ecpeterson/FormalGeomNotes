...
\todo{Mention not just what's to come but also what isn't. In particular, we're going to avoid $E_\infty$ geometry completely. We also don't really address applications; our goal is mostly to tell an internally consistent story about the role of formal geometry in bordism theory --- so no Dirac operators on loopspaces.  Talk also about the pace of the course, as things get kind of scary... somewhere? Where do they get scary?}
