...
On the level of the polynomials $g_n$, $g_m$, and $g_{n+m}$, this map is given by\todo{Make it clear that this product still has nilpotent non-leading coefficients.} \[(g_n, g_m) \mapsto x^{n+m} - (x^n - g_n(x)) \cdot (x^m - g_m(x)) =: g_{n+m}(x).\]
\end{remark}
