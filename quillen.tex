...
\end{tikzcd}
\end{center}
Given any identification \(P \simeq \coprod_K (* \mmod K)\),\footnote{These \(K\) are \emph{not} canonically identified with subgroups of \(H\).} there is a \index{push-pull}push-pull interchange formula
\[\pushQED{\qed}
