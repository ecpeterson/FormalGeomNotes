...
In light of the results in the introduction, it is prudent to develop some of the theory of formal schemes and formal varieties outside of the context of $\F_2$--algebras.
...
The map $d:R\to \Omega^1_{R/k}$ is the universal $k$-linear derivation into an $R$--module: \[\CatOf{Derivations}_k(R, M) = \CatOf{Modules}_R(\Omega^1_{R/k}, M). \qed\]
\end{lemma}
