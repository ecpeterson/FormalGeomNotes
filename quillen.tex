...
G \times X \arrow[shift left=0.2\baselineskip, "\mu"]{r} & X \arrow[shift left=.2\baselineskip, "\sum_g \{g\} \times -"]{l} .
\end{tikzcd}
\end{center}
...
\end{lemma}
\begin{proof}
\todo{The Tate construction kills free cells.}
\end{proof}
...
\end{corollary}
\begin{proof}
\todo{This proof is wrong. You either want Tate on the inside of the function spectrum or you want to be taking the smash power of the function spectrum (which requires some kind of K\"unneth thing to happen). I'm not sure how to fix this, and I can't find a reasonable reference.}
