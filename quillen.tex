...
\intertext{From here, we apply the splitting principle, multiplicativity of power operations, and application of the properties of Landweber--Novikov operations:}
\phi(P^{C_n}(c_m(\xi_m))) & = \phi(P^{C_n}(c_1(\L_1) \cdots c_1(\L_m))) \\
