...
\begin{remark}\todo{This is I.5.1 in Adams's blue book.}
...
transverse intersection is an easy push-pull formula.

the clean intersection formula. generalizes to nontransverse intersections.

the main relation: the $p$\th cyclic power operation is additive.
