...
\end{tikzcd}
\end{center}
is an isomorphism.  It follows from \Cref{DummyLazardsThm} that the top-left horizontal map is injective, hence an isomorphism.
\end{proof}
