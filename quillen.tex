...
\end{tikzcd}
\end{center}
For any identification \(P \simeq \coprod_K (* \mmod K)\),\footnote{This decomposition in terms of subgroups of \(H\) is \emph{not} canonical.} there is a \index{push-pull}push-pull interchange formula
\[\pushQED{\qed}
