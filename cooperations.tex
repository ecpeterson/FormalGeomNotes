...
\begin{lemma}
For a ring spectrum $E$ satisfying {\UFH}, the additive unstable cooperations form rings of functions on the objects and morphisms of a category scheme, and homology is valued in Cartesian quasicoherent sheaves over its nerve. \qed
\end{lemma}
