...
\begin{center}
\begin{tikzcd}
\HFtwo_* \OS{\HFtwo}{*} & \arrow["\simeq"']{l} \frac{\bigotimes_t \bigotimes_{j_1 < \cdots < j_t} \F_2[\alpha_{(j_1)} \circ \cdots \circ \alpha_{(j_t)}]}{(\alpha_J)^{\ast 2} = 0}.
\end{tikzcd}
