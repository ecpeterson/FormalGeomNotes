...
\end{align*}
where \(\Delta(a) = \sum_j a'_j \otimes a''_j\) and where the symbols \(a \ast a'\), \(a \circ a'\), and \(\chi a\) are all formal symbols.  There are four additional families of relations we might impose:
\begin{enumerate}
