...
\todo[inline]{Jeremy thought we got really close to outright proving Wilson's theorem.  We should figure out exactly how close we got and possibly close the gap.  (Could also be an excuse to understand Sinkinson's thesis.)}
