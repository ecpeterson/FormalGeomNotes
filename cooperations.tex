...
\begin{definition}
\citeme{You can find a definition for this too}
...
\begin{center}
\begin{tikzcd}
0 \arrow{r} & \mathbb G_1 \arrow{r} \arrow{d} & \mathbb G_j \arrow["p"]{r} \arrow{d} & \mathbb G_j \arrow{d} \\
0 \arrow{r} & \mathbb G_1 \arrow{r} & \mathbb G_{j+1} \arrow{r} & \mathbb G_{j+1}.
\end{tikzcd}
\end{center}
...
\begin{remark}[{\cite[Section 3]{HopkinsLurie}, \cite{HedayatzadehGeneralCase}, \cite{HedayatzadehFieldCase}}]
