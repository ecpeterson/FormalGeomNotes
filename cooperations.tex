...
\begin{definition}
In the setting of unstable homology cooperations, we define the collection of \index{operations!unstable}\textit{additive unstable cooperations} to be the \index{Hopf ring!star indecomposables@\(\ast\)--indecomposables}\(\ast\)--indecomposable quotient \(Q^* E_* \OS{E}{j}\).
\end{definition}
